  ...
  Show.Controller = {
    showHospital: function(id, aboutView, chartsView, defaultModel){ //received URL with ID parameter
      ...
      function changeHospital(model){
        ...
        aboutView.render();
        Marionette.triggerMethodOn(HospitalCheckup.module("InfectionsApp.List.chartView"), "select:hospital", model.get("display_name")); //add active class to chart hospital label
      }
    }
  }
});