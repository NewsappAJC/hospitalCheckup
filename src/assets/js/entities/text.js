...
/* ------ INFECTIONS ----- */
  Entities.InfectionIntroTxt = {
    ...
    intro_text: "<p>The federal government tracks infection control at hospitals nationwide, releasing new data quarterly. This information shows how often patients contract infections while getting care, when compared to similar hospitals. Public health experts say these types of infections are preventable if hospitals carefully follow protocols for infection prevention. This information is collected by the National Healthcare Safety Network at the U.S. Centers for Disease Control and Prevention.</p><p><strong>What’s included:</strong> The federal government uses a standardized infection ratio (SIR) to measure how well hospitals are doing on infection control for different types of infections patients often contract while getting healthcare. The SIR compares the number of infections in a hospital to a <a href='#benchmark'>national benchmark</a>. Click on the drop-down below to select a <a href='https://www.medicare.gov/hospitalcompare/about/complications.html' target='_blank'>type of infection</a>.</p><p><strong>Rate:</strong> The dot shows the risk-adjusted estimate of the rate (CMS adjusts the numbers based on the health of patients each hospital sees. That’s to make comparisons fair.) <strong>Lower numbers are better. A score of zero – meaning no infections – is best.</strong></p><p><strong>Range:</strong> The colored bar shows a range within which the true rate might fall. The rates are risk-adjusted estimates, after all, and CMS uses the range to indicate how precise its estimate is. The color code indicates how the score compares to the national benchmark. If the entire range is above or below the national benchmark, then CMS scores the hospital as better or worse than the benchmark.</p><p><strong>Who is included in this data:</strong> All patients treated in the hospital, including adult, pediatric, neonatal, Medicare and non-Medicare.</p><p><strong>Time period:</strong> 10/1/2013 to 9/30/2014.</p>",
